  ...
  <div class="relative flex items-top justify-center min-h-screen bg-gray-100 sm:items-center sm:pt-0">
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
        <h2 class="text-2xl leading-7 font-semibold">Welcome to the Nuxt / Express starter</h2>
        <p class="mt-3 text-gray-600">
          If you are not familiar with Nuxt / Express, we recommend you take a look at the
          <a href="https://nuxtjs.org" target="_blank" class="text-green-500 hover:underline">Nuxt documentation</a> and
          <a href="https://nuxtjs.org" target="_blank" class="text-green-500 hover:underline">Express documentation</a>,
          whether you are new or have previous experience with the framework.<br />
        </p>
        <nuxt-link to="product/get">See post</nuxt-link>
        <nuxt-link to="product/add">Add post</nuxt-link>
      </div>
      <div class="flex justify-center pt-4 space-x-2">
        <a href="https://github.com/ayoub9360" target="_blank"
          ><svg
